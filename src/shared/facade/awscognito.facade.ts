...
export default class AWSCognito {
  ...
  async confirmSignUp(
    args: AWSCognitoConfirmSignupInput,
  ): Promise<AWSCognitoConfirmSignupOutput> {
    try {
      ...
      return {
        isConfirm:
          response.$metadata.httpStatusCode === StatusCodes.OK ? true : false,
      };
    } catch (e: any) {
      if (e instanceof ExpiredCodeException) {
        ...
        throw new InternalServerError(
          "unexpected error in auth service confirm signup",
        );
      }
    }
  }

  async resendSignupConfirmationCode(
    args: AWSCognitoResendSignupCodeInput,
  ): Promise<AWSCognitoResendSignupCodeOutput> {
    try {
      const { email } = args;
      ...
      if (e instanceof CodeDeliveryFailureException) {
        ...
        throw new InternalServerError(
          "unexpected error occurred when trying to resend confirmation code",
        );
      }
    }
  }
  ...
  async signOut(
    args: AWSCognitoSignOutInput,
  ): Promise<AWSCognitoSignOutOutput> {
    try {
  ...
  async forgotpassword(
    args: AWSCognitoForgotPasswordInput,
  ): Promise<AWSCognitoForgotPasswordOutput> {
    try {
      const { email } = args;
  ...
  async confirmForgotPassword(
    ...
    try {
      ...
      if (e instanceof CodeMismatchException) {
        ...
        throw new InternalServerError(
          "unexpected error occurred in auth service confirmforgotpassword",
        );
      }
    }
  }
  ...
  async changePassword(
    args: AWSCognitoChangepasswordInput,
  ): Promise<AWSCognitoChangepasswordOutput> {
    try {
      ...
      return {
        isChanged:
          response.$metadata.httpStatusCode === StatusCodes.CREATED
            ? true
            : false,
      };
    } catch (err: any) {
  ...
  async updateProfile(
    args: AWSCognitoUpdateProfileInput,
  ): Promise<AWSCognitoUpdateProfileOutput> {
