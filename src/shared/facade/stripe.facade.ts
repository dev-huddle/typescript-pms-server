...
export default class Stripe {
  ...
  async paymentConfirm(args: PaymentConfirmInput): Promise<void> {
    try {
      ...
      const response = await stripe.paymentIntents.confirm(id, {
  ...
  async createCustomer(
    ...
    try {
      ...
      throw new InternalServerError(
        "failed attempt to create stripe customer account",
      );
    }
  }
  ...
  async deleteCustomer(
    ...
    try {
      ...
      throw new InternalServerError(
        "failed attempt to delete stripe customer account",
      );
    }
  }
  ...
  async deleteCard(payment_method_id: string): Promise<void> {
    try {
      ...
      throw new InternalServerError(
        "failed attempt to delete card from stripe",
      );
    }
  }

  async fetchCardDetails(
    args: FetchCardDetailsInput,
  ): Promise<FetchCardDetailsOutput> {
    try {
  ...
  async createPlan(
    args: StripeCreatePlanInput,
  ): Promise<StripeCreatePlanOutput> {
    try {
  ...
  async deletePlan(
    args: StripeDeletePlanInput,
  ): Promise<StripeDeletePlanOutput> {
    try {
      const { plan_id } = args;
  ...
  async createSubscription(
    args: StripeCreateSubscriptionInput,
  ): Promise<StripeCreateSubscriptionOutput> {
    try {
  ...
  async updateSubscription(
    args: StripeUpdateSubscriptionInput,
  ): Promise<StripeUpdateSubscriptionOutput> {
    try {
  ...
  async cancelSubscription(
    args: StripeCancelSubscriptionInput,
  ): Promise<StripeCancelSubscriptionOutput> {
    try {
