...
export default class SubscriptionService {
  ...
  async createSubscription(
    ...
    if (checkUser.active_plan) {
      ...
      const subscription =
        await this.subscriptionRepository.fetchActiveByUserId(checkUser._id!);
  ...
  async cancelSubscription(
    ...
    const response = await this.stripe.cancelSubscription({
      subscription_id: stripeResponse?.stripe_subscription_id!,
    });
