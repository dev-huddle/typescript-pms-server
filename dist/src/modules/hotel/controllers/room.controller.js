...
let HotelRoomController = class HotelRoomController {
    ...
    create(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const response = yield this.roomService.create({
                    number,
                    room_type_id,
                    status,
                    hotel_id,
    ...
    fetchAll(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const response = yield this.roomService.fetchAll();
                (0, helper_1.Res)({
                    res,
    ...
    fetchOne(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { id } = req.params;
                const response = yield this.roomService.fetchOne({ room_id: id });
                (0, helper_1.Res)({
                    res,
                    code: constants_1.StatusCodes.OK,
    ...
    update(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { id } = req.params;
                const response = yield this.roomService.update(Object.assign(Object.assign({}, req.body), { hotel_id: id }));
                (0, helper_1.Res)({
                    res,
                    code: constants_1.StatusCodes.OK,
    ...
    deleteOne(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { id } = req.params;
                yield this.roomService.delete({ room_id: id });
                (0, helper_1.Res)({
                    res,
...
HotelRoomController = __decorate([
    (0, tsyringe_1.injectable)(),
    __metadata("design:paramtypes", [services_1.RoomService])
], HotelRoomController);
exports.default = HotelRoomController;
