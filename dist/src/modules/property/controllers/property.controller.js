...
let PropertyController = class PropertyController {
    ...
    create(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const response = yield this.propertyService.create({
                    name,
                    creator_id: sub,
                    address,
                    type,
    ...
    fetchAll(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const response = yield this.propertyService.fetchAll({});
                (0, helper_1.Res)({
                    res,
    ...
    fetchOne(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { id } = req.params;
                const response = yield this.propertyService.fetchOne({ property_id: id });
                (0, helper_1.Res)({
                    res,
                    code: constants_1.StatusCodes.OK,
    ...
    deleteOne(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { id } = req.params;
                yield this.propertyService.delete({ property_id: id });
                (0, helper_1.Res)({
                    res,
...
PropertyController = __decorate([
    ...
    __metadata("design:paramtypes", [services_1.PropertyService])
], PropertyController);
